...
class Config:
    ...
    # Allow up to 50 MB uploads. Design files (hi-res logos, PNGs) can be
    ...
    # Hide until the Instagram, Facebook, and TikTok accounts are live.
    SHOW_SOCIAL_LINKS = os.environ.get('SHOW_SOCIAL_LINKS', 'false').lower() in ('1', 'true', 'yes')
