...
SOFTNESS_BY_STYLE = {
    ...
    'BC8800': (4, '65% polyester / 35% viscose, flowy racerback'),
    ...
    'RS3401': (2, '100% cotton jersey, substantial infant tee'),
    ...
    'DT6000': (2, 'Combed ring-spun cotton jersey; heather colors use cotton/poly blends'),
    'DT8000': (2, '60% recycled cotton / 40% recycled polyester jersey Re-Tee'),
    # GILDAN
    ...
    # INDEPENDENT TRADING CO. — fleece hand varies by weight and construction
    'IND3000': (1, '70% cotton / 30% polyester heavyweight fleece'),
    'IND4000': (1, '70% cotton / 30% polyester heavyweight fleece, hoodie'),
    ...
    'PRM30SBC': (3, '52% cotton / 48% polyester Special Blend fleece'),
    'PRM33SBP': (3, '52% cotton / 48% polyester Special Blend hoodie'),
    'PRM15YSB': (3, '52% cotton / 48% polyester Special Blend, youth'),
    'PRM15YSBC': (3, '52% cotton / 48% polyester Special Blend, youth'),
    'PRM10TSB': (3, '52% cotton / 48% polyester Special Blend, toddler'),
    'PRM10TSBC': (3, '52% cotton / 48% polyester Special Blend, toddler'),
    ...
    'ST254': (1, '100% polyester PosiCharge 1/4-zip performance pullover'),
