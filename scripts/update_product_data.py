...
PRODUCTS = {
    ...
    'DT6000': (
        8.18, 26.00,
        '4.3 oz combed ring-spun cotton jersey; heather, frost, and select colors use cotton/poly blends',
        "The District Very Important Tee is a soft, retail-quality jersey tee. Fiber content varies by color, with cotton solids and durable cotton/poly heathers.",
        "Unisex modern fit; true to size.",
        'https://cdnm.sanmar.com/SpecSheetMeasurements/DT6000.pdf',
    ),
    'DM130': (
        24.98, 50.00,
        '50% polyester, 25% combed ring-spun cotton, 25% rayon; 4.5 oz Perfect Tri jersey',
        "The District Perfect Tri Tee has a soft, heathered vintage look in a lightweight tri-blend jersey. It is a short-sleeve crewneck tee—not fleece or a hoodie.",
        "Unisex modern tee fit; runs slightly fitted. Size up for a relaxed look.",
        'https://cdnm.sanmar.com/SpecSheetMeasurements/DM130.pdf',
    ),
    'DT8000': (
        9.18, 27.00,
        '60% recycled cotton, 40% recycled polyester; 5.3 oz jersey (color blends vary)',
        "The District Re-Tee® is a short-sleeve crewneck jersey tee made from 100% recycled material. Substantial yet soft, it is a feel-good choice for eco-conscious customers.",
        "Unisex modern tee fit; true to size.",
    ...
    'RS3321': (
        ...
        "Rabbit Skins Toddler Fine Jersey Tee — a soft short-sleeve tee made from combed ring-spun cotton. Perfect for custom toddler gifts, sibling shirts, and little fans.",
        "Toddler sizing (2T–4T); runs true to toddler size.",
        'https://cdnm.sanmar.com/SpecSheetMeasurements/RS3321.pdf',
    ),
    'RS4400': (
        14.98, 32.00,
        '100% combed ring-spun cotton baby rib; 5.5 oz',
        "Rabbit Skins Infant Baby Rib Bodysuit — a soft one-piece bodysuit with lap shoulders and reinforced three-snap closure for easy changes.",
        "Infant bodysuit sizing; true to size.",
    ...
    'STTU169': (
        17.98, 40.00,
        '100% organic ring-spun cotton; 5.3 oz; GOTS certified',
        "The Stanley/Stella Stella Muser is a relaxed women's organic cotton tee with a modern silhouette and premium hand feel.",
        "Women's relaxed fit; true to size.",
        'https://cdnm.sanmar.com/SpecSheetMeasurements/STTU169.pdf',
    ),
    'STSW013': (
        48.98, 85.00,
        '85% organic combed cotton, 15% recycled polyester fleece; GOTS certified',
        "The Stanley/Stella Cruiser 2.0 is a premium pullover hoodie made from organic cotton and recycled polyester. It is not a full-zip hoodie.",
