# Bella+Canvas Product Descriptions & Size Charts

## Product Descriptions

Since S&S Activewear's API doesn't provide detailed product descriptions for Bella+Canvas items, here are the standard descriptions for your products:

### 3001 - Unisex Jersey Short Sleeve Tee
...
**Fabric:** 100% Airlume combed and ring-spun cotton, 32 singles (Ash - 99% Airlume combed and ring-spun cotton, 1% polyester; Heather colors - 52% cotton, 48% polyester; Athletic Heather and Black Heather - 90% cotton, 10% polyester)

**Weight:** 4.2 oz

**Fit:** Unisex sizing, retail fit, side-seamed

### 3001CVC - Unisex Jersey Short Sleeve Tee (CVC)
...
### 3001Y - Youth Jersey Short Sleeve Tee
...
**Fit:** Youth sizing, side-seamed

---

## Standard Bella+Canvas Size Chart

### Adult Unisex Sizes (3001, 3001CVC)
...
**Measurements:** All measurements are taken with garment laying flat. Chest width is measured 1" below armhole. Body length is measured from high point shoulder to bottom hem.

---

## Recommendation

**Use the bulk import script below** to add these descriptions to your database:
